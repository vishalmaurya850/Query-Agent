# Contributing Guidelines gitgoap
...
```bash
git clone https://github.com/<your-username>/Query-Agent
cd Query-Agent
git remote add upstream https://github.com/<upstream-owner>/Query-Agent
```  
...
https://github.com/vishalmaurya850/Query-Agent
